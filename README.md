...
* We want to choose the &#946;'s that minimize the above function. Notice the first bit of the objective function is just standard OLS. &#955; is a penalty parameter choosen by cross-validation.  As Lambda increases coefficents are shrunken towards zero.
