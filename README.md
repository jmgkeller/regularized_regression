...
* Notice the first bit of the objective function is just standard OLS. Lambda ( &#955; ) is a penalty parameter choosen by cross-validation.  As Lambda increases coefficents are shrunken towards zero.
